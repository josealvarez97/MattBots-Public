...
* **We have taken care to persist data of the user's locally (e.g., AchievementsData)**. For example, here are some excerpts of methods that save/load some data, and perform the necessary validatiosn and proper handling of common exceptions.
